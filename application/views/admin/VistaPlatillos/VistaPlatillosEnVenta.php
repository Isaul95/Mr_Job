          ...
          <div class="row">
            <div class="col-md-12 mt-5">
              <h1 class="text-center">
                <strong><font color="#D34787">Platillos para preparacion</font></strong>
              </h1>
          ...
          <div class="row">
            ...
            <div class="row my-4">
              <div class="col-md-12 mx-auto">
                ...
                <table id="tbl_platillosParaEntrega" class="table table-striped table-bordered dt-responsive nowrap table-hover table-condensed" cellspacing="0" style="background:white!important" width=100%>
                  <thead class="text-center bg-primary">
                    <tr>
                      <th width="3%" type="hidden">id</th>
                      <th width="3%" type="hidden">platillo</th>
                      <th width="3%" type="hidden">venta</th>
                      <th>Nombre cliente</th>
                      <th class="text-center" width="11%">Fecha y Hora entrega</th>
                      <th>Lugar</th>
                      <th class="text-center" width="10%">Platillo</th>
                      <th class="text-center" width="10%">Precio</th>
                      <th class="text-center" width="10%"># personas</th>
                    </tr>
                  </thead>
                </table>
